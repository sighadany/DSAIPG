...
public class FourAryHeapTest {
    ...
    public void testUnordered1() {
        ...
        binHeap[2] = "B";
        boolean max = false;
        Iterable<String> pq = new FourAryHeap<>(max, binHeap, 1, 2, Comparator.comparing(String::toString), false);
    ...
    public void testSwimUp0() {
        ...
        Iterable<String> pq = new FourAryHeap<>(true, binHeap, 0, 2, Comparator.comparing(String::toString), true);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testSwimUp1() {
        ...
        Iterable<String> pq = new FourAryHeap<>(true, binHeap, 1, 2, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    // This test does not word for 4-ary heaps because in [ , Z, A, B, C] the parent (Z) and the children (A, B, C) sre in order
    // there is no change when we swim
//    @Test
...
//        Iterable<String> pq = new FourAryHeap<>(true, binHeap, 1, 4, Comparator.comparing(String::toString), false);
//        final PrivateMethodTester tester = new PrivateMethodTester(pq);
...
//    }
    ...
    public void testSwimUp3() {
        ...
        Iterable<String> pq = new FourAryHeap<>(false, binHeap, 1, 4, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testSink0() {
        ...
        binHeap[1] = b;
        binHeap[2] = c;
        Iterable<String> pq = new FourAryHeap<>(true, binHeap, 0, 3, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testSink1() {
        ...
        binHeap[2] = b;
        binHeap[3] = c;
        Iterable<String> pq = new FourAryHeap<>(true, binHeap, 1, 3, Comparator.comparing(String::toString), false);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
    ...
    public void testGive1() {
        FourAryHeap<String> pq = new FourAryHeap<>(10, Comparator.comparing(String::toString));
        String key = "A";
        pq.give(key);
    ...
    public void testGive2() {
        ...
        FourAryHeap<String> pq = new FourAryHeap<>(1, Comparator.comparing(String::toString));
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        String key = "A";
    ...
    @Test
    public void isEmpty() {
        FourAryHeap<String> pq = new FourAryHeap<>(10, false, Comparator.comparing(String::toString));
        assertTrue(pq.isEmpty());
    }
    ...
    public void doTake01() throws PQException {
        ...
        binHeap[1] = "B";
        binHeap[2] = "C";
        FourAryHeap<String> pq = new FourAryHeap<>(false, binHeap, 0, 3, Comparator.comparing(String::toString), false);
        pq.doTake(pq::snake);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        assertEquals("B", tester.invokePrivate("peek", 0));
    }
    ...
    public void doTake02() throws PQException {
        ...
        binHeap[1] = "A";
        binHeap[2] = "B";
        FourAryHeap<String> pq = new FourAryHeap<>(true, binHeap, 0, 3, Comparator.comparing(String::toString), false);
        pq.doTake(pq::sink);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        assertEquals("B", tester.invokePrivate("peek", 0));
    }
    ...
    public void doTake11() throws PQException {
        ...
        binHeap[2] = "B";
        binHeap[3] = "C";
        FourAryHeap<String> pq = new FourAryHeap<>(false, binHeap, 1, 3, Comparator.comparing(String::toString), false);
        pq.doTake(pq::snake);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        assertEquals("B", tester.invokePrivate("peek", 1));
    }
    ...
    public void doTake12() throws PQException {
        ...
        binHeap[2] = "A";
        binHeap[3] = "B";
        FourAryHeap<String> pq = new FourAryHeap<>(true, binHeap, 1, 3, Comparator.comparing(String::toString), false);
        pq.doTake(pq::sink);
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
        assertEquals("B", tester.invokePrivate("peek", 1));
    }
    ...
    public void testGetMax() {
        Iterable<String> pq = new FourAryHeap<>(10, false, Comparator.comparing(String::toString));
        final PrivateMethodTester tester = new PrivateMethodTester(pq);
