...
//
//            // Inside the moves() method, add this before the if check
//            List<int[]> potentialMoves = position.moves(player);
//            System.out.println("Potential moves from position: " + (potentialMoves != null ? potentialMoves.size() : "null"));
//
...
//        }
        ...
        public Collection<Move<TicTacToe>> moves(int player) {
            ...
            List<int[]> moves = position.moves(player);
//            System.out.println("Potential moves from position: " + (moves != null ? moves.size() : "null"));
